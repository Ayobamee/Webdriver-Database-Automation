...
public class DisputeCreationTest  {
BaseTest dr = new BaseTest();

@Test 
public void CreateValidateCheck () throws InterruptedException {
dr.SetUp();	
dr.IssuerLogin();
CreateDispute();
dr.closePage();
...
WebElement TranId = dr.driver.findElement(By.linkText("34171025"));
TranId.click();
