...
public class agentViewTest extends TestBase {
...
public void agentViewcheck () throws IOException {
...
//Import view agent repo
ViewAgentPage vA = new ViewAgentPage(driver);
//Click Agents
vA.Agents().click();

//Click See all Agents

vA.ListAgent().click();


//Validate Agents can be viewed

if(vA.DisplayAgent()!= null){
	
System.out.println("Agents referred are populated succesfully ");


}else{
System.out.println("Agents are not showing");
}
