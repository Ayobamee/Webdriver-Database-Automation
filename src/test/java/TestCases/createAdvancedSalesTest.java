...
import ObjectRepository.createAdvancedSalesPage;
...
public class createAdvancedSalesTest extends TestBase {
...
//Import Advanced sales repo	
createAdvancedSalesPage advancedSales = new createAdvancedSalesPage(driver);

//Click Advanced Sales
advancedSales.advancedSale().click();
...
//Add products
advancedSales.addproducts().click();

//Choose product
advancedSales.pickProduct().click();

//Add product to advanced sale
advancedSales.productToSale().click();

//Input payment amount
advancedSales.paymentAmount().sendKeys("1000");


//Add sale
advancedSales.addSale().click();


//Validate Advanced sale is successful
if(advancedSales.successfulAdvancedSale()!= null){
			
System.out.println("Advanced sale was recorded successfully");

		}
	else{
		System.out.println("Advanced sale was not recorded successfully");
		}
